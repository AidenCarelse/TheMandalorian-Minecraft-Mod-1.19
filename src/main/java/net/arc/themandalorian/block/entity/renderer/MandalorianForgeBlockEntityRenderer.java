package net.arc.themandalorian.block.entity.renderer;
...
public class MandalorianForgeBlockEntityRenderer implements BlockEntityRenderer<MandalorianForgeBlockEntity> {

    public MandalorianForgeBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(MandalorianForgeBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
        ...
        switch (pBlockEntity.getBlockState().getValue(MandalorianForgeBlock.FACING)) {
